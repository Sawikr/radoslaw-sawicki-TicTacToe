...
public class Board {
    ...
    public boolean isGameOver(char[][] board) {
        return (hasPlayerWonInGame(board, PLAYER_X) || hasPlayerWonInGame(board, PLAYER_O) || getAvailableCells(board).isEmpty());
    }
    ...
    public boolean hasPlayerWonInGame(char[][] board, int player) {
        ...
        return checkOneDiagonal(board, player) || checkTwoDiagonal(board, player) ||
                checkWinInRows(board, player) || checkWinInColumns(board, player);
    }

    public boolean checkOneDiagonal(char[][] board, int player) {
    ...
    public boolean checkTwoDiagonal(char[][] board, int player) {
        int dim = board.length;
    ...
    public boolean checkWinInRows(char[][] board, int player) {
        int dim = board.length;
    ...
    public boolean checkWinInColumns(char[][] board, int player) {
        int dim = board.length;
    ...
    public int miniMax(char[][] board, int depth, int turn) {
        if (hasPlayerWonInGame(board, PLAYER_X))
        //if (hasPlayerWon(board, PLAYER_X))
            return 1;
        if (hasPlayerWonInGame(board, PLAYER_O))
